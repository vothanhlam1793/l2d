...
app.get('/hanoi.php', function (req, res) {
  res.redirect('/l2d/?map=map001&bot=web004')
})

app.get('/saigon.php', function (req, res) {
  res.redirect('/l2d/?map=map001&bot=web005')
})

app.get('/dalat.php', function (req, res) {
  res.redirect('/l2d/?map=map001&bot=web006')
})

app.use(function (req, res, next) {
  console.log('NEX')
  res.redirect('/l2d/?map=map001&bot=web003')
})
